...
public class MahasiswaForm extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("CRUD Data Mahasiswa Perpustakaan");

        lblId.setText("ID Member");

        lblJudul.setText("Nama Member");
        ...
        tableMember.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Member", "Nama Member", "Alamat", "Postal"
            }
        ) {
    ...
    private void initTableModel() {
        tableModel = new DefaultTableModel(new String[]{"ID Member", "Nama Member", "Alamat", "Postal"}, 0) {
            @Override
