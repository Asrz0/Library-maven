...
public class DashboardForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        menuDataMahasiswa = new javax.swing.JMenuItem();
        ...
        desktopPaneLayout.setHorizontalGroup(
            ...
            .addGroup(desktopPaneLayout.createSequentialGroup()
                ...
                .addGroup(desktopPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblWelcome, javax.swing.GroupLayout.DEFAULT_SIZE, 780, Short.MAX_VALUE)
        ...
        menuDataMahasiswa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menuDataMahasiswaActionPerformed(evt);
            }
        });
        menuMaster.add(menuDataMahasiswa);
    ...
    private void menuDataMahasiswaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuDataMahasiswaActionPerformed
        onOpenMahasiswa(evt);
    }//GEN-LAST:event_menuDataMahasiswaActionPerformed
    ...
    private void onOpenMahasiswa(ActionEvent event) {
        MahasiswaForm mahasiswaForm = findOpenMahasiswaForm();
        if (mahasiswaForm == null) {
            mahasiswaForm = new MahasiswaForm();
            desktopPane.add(mahasiswaForm);
            mahasiswaForm.setVisible(true);
        }

        try {
            mahasiswaForm.setIcon(false);
            mahasiswaForm.setSelected(true);
            mahasiswaForm.toFront();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Form buku sudah dibuka.");
        }
    }
    ...
    private MahasiswaForm findOpenMahasiswaForm() {
        for (JInternalFrame frame : desktopPane.getAllFrames()) {
            if (frame instanceof MahasiswaForm && !frame.isClosed()) {
                return (MahasiswaForm) frame;
            }
        }
        return null;
    }
    ...
    private javax.swing.JMenuItem menuDataMahasiswa;
